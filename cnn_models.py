...
class ResNet(nn.Module):   # general ResNet class that can be used to create ResNet18, ResNet34, etc.
    
    # Implementation based on PyTorch ResNet architecture
    # Reference: https://docs.pytorch.org/vision/main/_modules/torchvision/models/resnet.html#resnet18
